...
//!{filter yapan kısım} filte' ihtiyacım olmadığında boş bırktım  "toppingIds populate yapan kısım" populate'e ihtiyacım var
    res.status(200).send({
      error: false,
  ...
  create: async (req, res) => {
    ...
    req.body.toppingIds = [...new Set(toppingIds)]; // [1,1,2,2,3,3,5]=>[1,2,3,5] //! burada set'e aynı değerden 1den fazla verildiğinde unique'olanı seçiyor
