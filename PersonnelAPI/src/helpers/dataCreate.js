...
async function dataCreate() {
  ...
  await Department.deleteMany(); //! İlk başta silip sonradan oluşturuyoruz
  await Department.insertMany(departments);
  await Personnel.deleteMany();
  let isFirstAccount = (await Personnel.countDocuments()) === 0;// ilk kullanıcıya admin olmasına izin ver
